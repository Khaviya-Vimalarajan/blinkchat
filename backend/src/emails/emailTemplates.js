export function createWelcomeEmailTemplate(name, clientURL) {
  ...
  <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f5f5f5;">
    <div style="background: linear-gradient(to right, #11998e, #38ef7d); padding: 30px; text-align: center; border-radius: 12px 12px 0 0;">
    ...
    <div style="background-color: #ffffff; padding: 35px; border-radius: 0 0 12px 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
      <p style="font-size: 18px; color: #11998e;"><strong>Hello ${name},</strong></p>
      ...
      <div style="background-color: #f8f9fa; padding: 25px; border-radius: 10px; margin: 25px 0; border-left: 4px solid #11998e;">
      ...
      <div style="text-align: center; margin: 30px 0;">
        <a href=${clientURL} style="background: linear-gradient(to right, #11998e, #38ef7d); color: white; text-decoration: none; padding: 12px 30px; border-radius: 50px; font-weight: 500; display: inline-block;">Open Messenger</a>
      </div>
    ...
    <div style="text-align: center; padding: 20px; color: #999; font-size: 12px;">
      ...
      <p>
        <a href="#" style="color: #11998e; text-decoration: none; margin: 0 10px;">Privacy Policy</a>
        <a href="#" style="color: #11998e; text-decoration: none; margin: 0 10px;">Terms of Service</a>
        <a href="#" style="color: #11998e; text-decoration: none; margin: 0 10px;">Contact Us</a>
      </p>
    </div>
  </body>
  </html>
