...
function ChatHeader() {
  ...
  const displayPic = isGroup ? (selectedUser.avatar || "") : (selectedUser.profilePic || "");
    ...
    <div className="flex justify-between items-center bg-purple-950/60 backdrop-blur-xl border-b border-purple-900/80 py-4 px-6 shrink-0 shadow-sm z-10">
      <div className="flex items-center space-x-4">
        <div className={`avatar ${isGroup ? "" : isOnline ? "online" : "offline"}`}>
          <div className="w-11 h-11 rounded-full overflow-hidden ring-2 ring-purple-900 shadow-md bg-purple-900 flex items-center justify-center">
            {displayPic ? (
        ...
        <div>
          <h3 className="text-purple-100 font-semibold tracking-wide text-sm">{displayName}</h3>
